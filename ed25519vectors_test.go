...
import (
	...
	ed25519_sha3_512 "github.com/crpt/go-ed25519-sha3-512"
	"github.com/crpt/go-ed25519-sha3-512/internal/testenv"
)
...
// TODO: Find new test data to replace `https://github.com/FiloSottile/mostly-harmless/tree/main/ed25519vectors`
func TestEd25519Vectors(t *testing.T) {
	t.Skip("TODO: Find new test data to replace `https://github.com/FiloSottile/mostly-harmless/tree/main/ed25519vectors`")
	...
	for i, v := range vectors {
		...
		didVerify := ed25519_sha3_512.Verify(publicKey, message, signature)
